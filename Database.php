...
//select funkcija
function select ($table="igracka", $rows = 'igracka.igrackaID, igracka.nazivIgracke, igracka.proizvodjac, igracka.cena, igracka.opis,  igracka.slika,  igracka.stanje,  igracka.tipIgrackeID,  tipigracke.pol, kategorijaigracke.nazivKategorije', $join_table="tipigracke", $join_key1="tipIgrackeID", $join_key2="tipIgrackeID", $join_table2="kategorijaigracke", $join_key3="kategorijaIgrackeID", $join_key4="kategorijaIgrackeID", $where = null, $order = null)
 {
...
function insert ($table="kategorijaigracke", $rows = "nazivKategorije", $values)
{
...
function update ($table="igracka", $id, $keys, $values)
{
$set_query = array();
...
$update = "UPDATE ".$table." SET ". $set_query_string ." WHERE igrackaID=". $id;
//echo($update);
if (($this->ExecuteQuery($update)) && ($this->affected >0))
return true;
else return false;
}
function delete ($table="kategorijaigracke",  $keys, $values)
{
