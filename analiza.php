...
header("Content-type: application/json");?>
    ...
    $array['cols'][] = array('label' => 'Broj igracaka', 'type' => 'number');
 
$sql="SELECT korisnik,count(kupovinaID) AS 'ukupno' FROM kupovina k INNER JOIN igracka i ON (i.igrackaID=k.igrackaID) GROUP BY korisnik";
