...
if ($db->ubaciIgracku($podaci)) {
    echo "<div class='alert alert-success'><p id=\"2\">Uspešno dodavanje nove igračke u ponudu.</p></div>";
} else {
...
unlink($target_file);}
 echo "<div class='alert alert-danger'><p id=\"2\">Neuspesno dodavanje igračke!!!</p></div>";
}
?>
